 ...
 * @param data
 */
static void pdu_hash_unitData(PduDataUnit *unit, pdu_dev_data *data)
{
 ...
 * @param data
 */
static void pdu_hash_objData(PduObjData *obj,pdu_dev_data *data)
{
    PduDataBase *ptr = NULL;
    int sizeBit = 2;
 ...
 * @param data
 */
static void pdu_hash_envData(PduEnvData *env,pdu_dev_data *data)
{
    PduDataBase *ptr = NULL;
    int sizeBit = 1;
 ...
 * @param data
 */
void pdu_hashDevData_save(PduDevData *dev,pdu_dev_data *data)
{
    ...
    case PDU_CMD_LINE: //相电气参数
        pdu_hash_objData(dev->line, data);
        break;
