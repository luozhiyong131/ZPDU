 ...
 * @param sizeBit
 */
void pdu_saveHash_intData(PduDataBase *ptr, ushort len, uchar *data, int sizeBit)
{
 ...
 * @param data
 */
void pdu_saveHash_string(PduStrBase *strBase, ushort len, uchar *data)
{
   QString str;
 ...
 * @param data
 */
void pdu_devStr_save(PduStrBase *strBase, pdu_dev_data *data)
{
